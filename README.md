...
|---|---|
| **Persona-based agents** | 5 AI personas (Product, Architect, Developer, Modernization Lead, Team Lead) — each with a distinct role, communication style, and skill set |
...
Creates `_superml/persona.yml` with your name, role, AI tool preference, and skill level. This file is personal and stays out of git.
