...
```
@agent-pm               ← agent picker (recommended)
/agent-pm               ← slash command
...
├── agents/
│   ├── agent-pm.agent.md         Copilot agent picker entry — Product / BA
│   ├── agent-architect.agent.md  Copilot agent picker entry — Architect
│   ├── agent-developer.agent.md  Copilot agent picker entry — Developer
│   ├── agent-sage.agent.md       Copilot agent picker entry — Modernization Lead
│   ├── agent-lead.agent.md       Copilot agent picker entry — Team Lead / PM
│   └── agent-scout.agent.md      Copilot agent picker entry — Code Archaeologist
├── skills/
│   └── <skill-name>/SKILL.md     One per skill — appears as /skill-name slash command
...
|---------|-------------|---------------|------|---------------|
| Product / BA | Aria | `@agent-pm` | Requirements, PRDs, user stories | `_superml/skills/2-planning/agent-pm/SKILL.md` |
| Architect | Rex | `@agent-architect` | System design, ADRs, architecture | `_superml/skills/3-solutioning/agent-architect/SKILL.md` |
| Developer | Nova | `@agent-developer` | Implementation, code review, tech debt | `_superml/skills/4-implementation/agent-developer/SKILL.md` |
| Modernization Lead | Sage | `@agent-sage` | Legacy analysis, migration planning | `_superml/skills/5-modernize/agent-sage/SKILL.md` |
| Team Lead / PM | Lead | `@agent-lead` | Epics, sprint planning, delivery | `_superml/skills/4-implementation/sprint-planning/SKILL.md` |
| Code Archaeologist | Scout | `@agent-scout` | Codebase onboarding, reverse-engineer docs | `_superml/skills/0-relearn/agent-scout/SKILL.md` |
