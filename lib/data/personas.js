...
const PERSONAS = [
  {
    ...
    starterSkill: 'skills/2-planning/agent-pm/SKILL.md',
  },
  {
    key:            'architect',
    name:           'Rex',
    ...
    starterSkill: 'skills/3-solutioning/agent-architect/SKILL.md',
  },
  {
    key:            'developer',
    name:           'Nova',
    ...
    starterSkill: 'skills/4-implementation/agent-developer/SKILL.md',
  },
  {
    key:            'modernization',
    name:           'Sage',
    ...
    starterSkill: 'skills/5-modernize/agent-sage/SKILL.md',
  },
  {
    key:            'team_lead',
    name:           'Lead',
    ...
    starterSkill: 'skills/4-implementation/sprint-planning/SKILL.md',
  },
];
