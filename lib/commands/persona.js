...
function showNextSteps(config, primaryPersona, aiTools) {
  ...
  if (useCopilot) {
    const agentName = {
      product: 'agent-pm', architect: 'agent-architect', developer: 'agent-developer',
      modernization: 'agent-sage', team_lead: 'agent-lead',
    }[primaryPersona] || 'agent-scout';
