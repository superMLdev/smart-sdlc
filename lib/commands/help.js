...
const FLOWS = {
  product: {
    ...
    steps: [
      ...
      { label: 'Write product brief',       slash: 'sml-agent-pm',        file: '2-planning/agent-pm'               },
  ...
  team_lead: {
    ...
    steps: [
      ...
      { label: 'Sprint status',             slash: 'sml-sprint-status',         file: '4-implementation/sprint-status'      },
      { label: 'Retrospective',             slash: 'sml-retrospective',         file: '4-implementation/retrospective'      },
    ],
  },
  qa: {
    role:  'QA / Test Lead',
    agent: 'sml-agent-qa',
    steps: [
      { label: 'Write test plan',           slash: 'sml-test-plan',             file: '6-quality/test-plan'                 },
      { label: 'Execute tests',             slash: 'sml-test-execution',        file: '6-quality/test-execution'            },
      { label: 'Bug triage',                slash: 'sml-bug-triage',            file: '6-quality/bug-triage'                },
      { label: 'QA sign-off',               slash: 'sml-qa-signoff',            file: '6-quality/qa-signoff'                },
    ],
  },
  release: {
    role:  'Release Manager',
    agent: 'sml-agent-release',
    steps: [
      { label: 'Release checklist',         slash: 'sml-release-checklist',     file: '7-release/release-checklist'         },
      { label: 'Deploy runbook',            slash: 'sml-deploy-runbook',        file: '7-release/deploy-runbook'            },
      { label: 'Release notes',             slash: 'sml-release-notes',         file: '7-release/release-notes'             },
    ],
  },
};
...
const AGENTS = [
  ...
  { name: 'sml-agent-qa',        role: 'QA / Test Lead',      desc: 'Test plans, execution, bug triage, sign-off' },
  { name: 'sml-agent-release',   role: 'Release Manager',     desc: 'Release checklist, deploy runbook, release notes' },
];
...
function printFooter() {
  ...
  log.item(`npx @supermldev/smart-sdlc reenter   — re-enter any prior SDLC phase`);
  log.item(`npx @supermldev/smart-sdlc persona   — install or re-install your persona`);
  log.item(`npx @supermldev/smart-sdlc persona status — show installed persona`);
  log.item(`npx @supermldev/smart-sdlc persona exit   — exit current persona`);
  log.item(`npx @supermldev/smart-sdlc update    — update skills to latest`);
  log.line('');
}
