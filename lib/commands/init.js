...
function buildConfig({ projectName, teamName, projectType, docsPath, enabledIntegrations, personaNames = {}, readyArtifacts = [], aiTools = [], atlassianMcp = false }) {
