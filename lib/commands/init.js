...
async function runInit(rl, projectRoot) {
  ...
  // 7. Agent files for GitHub Copilot agent picker (one per persona)
  if (usesCopilot) {
  ...
  log.summary([
    ...
    ...(usesCopilot ? [{ label: 'Agents', value: '.github/agents/', ok: true }] : []),
  ]);
...
const PERSONA_AGENT_CONFIG = {
  product: {
    ...
    role:      'Product / BA',
    crossover: [
      '@agent-architect for architecture and technical design decisions',
      '@agent-developer for implementation feasibility',
    ],
  },
  architect: {
    ...
    role:      'Architect',
    crossover: [
      '@agent-pm for requirements and product decisions',
      '@agent-developer for implementation details',
    ],
  },
  developer: {
    agentName:    'agent-developer',
    ...
    role:      'Developer',
    crossover: [
      '@agent-architect for design and architecture decisions',
      '@agent-pm for requirements and acceptance criteria',
    ],
  },
  modernization: {
    agentName:    'agent-sage',
    ...
    crossover: [
      '@agent-architect for target architecture decisions',
      '@agent-pm for business requirements and domain rules',
    ],
  },
  team_lead: {
    agentName:    'agent-lead',
    ...
    role:      'Team Lead / PM',
    crossover: [
      '@agent-pm for requirements and product direction',
      '@agent-architect for technical planning',
    ],
  },
};
...
const SCOUT_AGENT_CONFIG = {
  ...
  crossover: [
    '@agent-architect for architecture decisions based on findings',
    '@agent-sage for legacy modernization planning',
  ],
};
